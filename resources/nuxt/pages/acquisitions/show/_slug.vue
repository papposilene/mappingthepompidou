...
export default {
    ...
    methods: {
        async fetchData() {
            ...
            axios.get('https://etp.psln.nl/api/acquisitions/show/' + this.$route.params.slug )
                .then(response => {
        ...
        async fetchArtworks() {
            ...
            axios.get('https://etp.psln.nl/api/acquisitions/show/' + this.$route.params.slug + '/artworks?page=' + pageNumber)
                .then(response => {
        ...
        async renderChart() {
            ...
            axios.get('https://etp.psln.nl/api/statistics/acquisitions/for-' + this.$route.params.slug + '/departments')
                .then(response => {
