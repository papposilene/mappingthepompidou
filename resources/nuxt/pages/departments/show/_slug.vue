...
export default {
    ...
    methods: {
        async fetchData() {
            ...
            axios.get('https://etp.psln.nl/api/1.1/departments/show/' + this.$route.params.slug )
                .then(response => {
        ...
        async fetchArtworks() {
            ...
            axios.get('https://etp.psln.nl/api/1.1/departments/show/' + this.$route.params.slug + '/artworks?page=' + pageNumber)
                .then(response => {
