...
export default {
    ...
    methods: {
        async fetchData() {
            ...
            axios.get('https://etp.psln.nl/api/1.1/movements/show/' + this.$route.params.uuid )
                .then(response => {
        ...
        async fetchArtists() {
            ...
            axios.get('https://etp.psln.nl/api/1.1/movements/show/' + this.$route.params.uuid + '/artists?page=' + pageNumber)
                .then(response => {
        ...
        async fetchArtworks() {
            ...
            let pageNumber = currentPage ? currentPage : 1;
            axios.get('https://etp.psln.nl/api/1.1/movements/show/' + this.$route.params.uuid + '/artworks?page=' + pageNumber)
                .then(response => {
